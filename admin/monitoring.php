...
<?php } else { ?>
   <div class="card">
      <div class="p-3">
         <form id="formFilterMonitoring">
            <div class="row">
               <div class="col-12 col-md-3 col-lg-3 my-2">
                  <select name="what_monitoring" id="what_monitoring" class="custom-select" required>
                     <option value=""></option>
                     <option>Siswa</option>
                     <option>Guru</option>
   ...
   <script>
      ...
      $('#what_monitoring').change(function() {
         var val = $(this).val();
         if (val == 'Siswa') {
